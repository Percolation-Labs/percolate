...
def generate_configmaps(input_folder="../sql", output_folder=".", namespace="test", apply=False):
...
"""
        ...
        if apply:
            try:
                ...
                print(f"❌ Failed to apply {configmap_path}. Check Kubernetes configuration.")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate Kubernetes ConfigMaps for SQL files")
    parser.add_argument("--input-folder", default="../sql", help="Folder containing SQL files (default: ../sql)")
    parser.add_argument("--output-folder", default=".", help="Folder to save ConfigMaps (default: .)")
    parser.add_argument("--namespace", default="p8", help="Kubernetes namespace (default: test)")
    parser.add_argument("--apply", action="store_true", help="Apply the generated ConfigMaps using kubectl")

    args = parser.parse_args()
    generate_configmaps(args.input_folder, args.output_folder, args.namespace, args.apply)
