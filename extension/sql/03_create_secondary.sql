...
INSERT INTO p8."ModelField" (name, id, entity_name, field_type, embedding_provider, description, is_key) VALUES
 ...
 ('roles', '75e4a87a-c813-47d5-9996-ee1505099793', 'p8.User', 'str', NULL, 'A list of roles the user is a member of - DEPRECATED! use groups instead', False),
 ('role_level', 'b1e95513-1e65-4c79-602c-5bf202909f04', 'p8.User', 'int', NULL, 'User''''s role level for security (0=God, 1=Admin, 5=Internal, 10=Partner, 100=Public)', False),
 ('groups', '7402a942-0d2d-bc6c-2e2f-ea50ce5dfe52', 'p8.User', 'str', NULL, 'List of groups the user belongs to', False),
 ...
 ('userid', 'a389cb4e-54bf-ad37-035e-55b6dc5c47a1', 'p8.User', 'str', NULL, 'Allow setting user id by default', False)
...
INSERT INTO p8."ModelField" (name, id, entity_name, field_type, embedding_provider, description, is_key) VALUES
 ...
 ('metadata', '97c1bef7-04f3-5abe-5b4f-40762b0651c0', 'p8.Agent', 'dict', NULL, 'Custom metadata added to the agent', False)
    ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, entity_name = EXCLUDED.entity_name, field_type = EXCLUDED.field_type, embedding_provider = EXCLUDED.embedding_provider, description = EXCLUDED.description, is_key = EXCLUDED.is_key;
-- ------------------
