...
```{''''description'''': ''''Tracks groups if session dialogue'''', ''''properties'''': {''''id'''': {''''anyOf'''': [{''''format'''': ''''uuid'''', ''''type'''': ''''string''''}, {''''type'''': ''''string''''}], ''''title'''': ''''Id''''}, ''''name'''': {''''anyOf'''': [{''''type'''': ''''string''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''The name is a pseudo name to make sessions node compatible'''', ''''title'''': ''''Name''''}, ''''query'''': {''''anyOf'''': [{''''type'''': ''''string''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''the question or context that triggered the session'''', ''''embedding_provider'''': ''''default'''', ''''title'''': ''''Query''''}, ''''user_rating'''': {''''anyOf'''': [{''''type'''': ''''number''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''We can in future rate sessions to learn what works'''', ''''title'''': ''''User Rating''''}, ''''agent'''': {''''default'''': ''''Percolate always expects an agent but we support passing a system prompt which we treat as anonymous agent'''', ''''title'''': ''''Agent'''', ''''type'''': ''''string''''}, ''''parent_session_id'''': {''''anyOf'''': [{''''format'''': ''''uuid'''', ''''type'''': ''''string''''}, {''''type'''': ''''string''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''A session is a thread from a question+prompt to completion. We span child sessions'''', ''''title'''': ''''Parent Session Id''''}, ''''thread_id'''': {''''anyOf'''': [{''''type'''': ''''string''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''An id for a thread which can contain a number of sessions'''', ''''title'''': ''''Thread Id''''}, ''''channel_id'''': {''''anyOf'''': [{''''type'''': ''''string''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''The channel through which the user came. It could be a messaging platform channel or a system division'''', ''''title'''': ''''Channel Id''''}, ''''channel_type'''': {''''anyOf'''': [{''''type'''': ''''string''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''The channel type'''', ''''title'''': ''''Channel Type''''}, ''''metadata'''': {''''anyOf'''': [{''''type'''': ''''object''''}, {''''type'''': ''''null''''}], ''''description'''': ''''Arbitrary metadata'''', ''''title'''': ''''Metadata''''}, ''''session_completed_at'''': {''''anyOf'''': [{''''format'''': ''''date-time'''', ''''type'''': ''''string''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''An audit timestamp to write back the completion of the session - its optional as it should manage the last timestamp on the AI Responses for the session'''', ''''title'''': ''''Session Completed At''''}, ''''graph_paths'''': {''''anyOf'''': [{''''items'''': {''''type'''': ''''string''''}, ''''type'''': ''''array''''}, {''''type'''': ''''null''''}], ''''default'''': None, ''''description'''': ''''Track all paths extracted by an agent as used to build the KG over user sessions'''', ''''title'''': ''''Graph Paths''''}}, ''''required'''': [''''id''''], ''''title'''': ''''Session'''', ''''type'''': ''''object''''}``` 

# Functions
 ```
None```
            ', '{"description": "Tracks groups if session dialogue", "properties": {"id": {"anyOf": [{"format": "uuid", "type": "string"}, {"type": "string"}], "title": "Id"}, "name": {"anyOf": [{"type": "string"}, {"type": "null"}], "default": null, "description": "The name is a pseudo name to make sessions node compatible", "title": "Name"}, "query": {"anyOf": [{"type": "string"}, {"type": "null"}], "default": null, "description": "the question or context that triggered the session", "embedding_provider": "default", "title": "Query"}, "user_rating": {"anyOf": [{"type": "number"}, {"type": "null"}], "default": null, "description": "We can in future rate sessions to learn what works", "title": "User Rating"}, "agent": {"default": "Percolate always expects an agent but we support passing a system prompt which we treat as anonymous agent", "title": "Agent", "type": "string"}, "parent_session_id": {"anyOf": [{"format": "uuid", "type": "string"}, {"type": "string"}, {"type": "null"}], "default": null, "description": "A session is a thread from a question+prompt to completion. We span child sessions", "title": "Parent Session Id"}, "thread_id": {"anyOf": [{"type": "string"}, {"type": "null"}], "default": null, "description": "An id for a thread which can contain a number of sessions", "title": "Thread Id"}, "channel_id": {"anyOf": [{"type": "string"}, {"type": "null"}], "default": null, "description": "The channel through which the user came. It could be a messaging platform channel or a system division", "title": "Channel Id"}, "channel_type": {"anyOf": [{"type": "string"}, {"type": "null"}], "default": null, "description": "The channel type", "title": "Channel Type"}, "metadata": {"anyOf": [{"type": "object"}, {"type": "null"}], "description": "Arbitrary metadata", "title": "Metadata"}, "session_completed_at": {"anyOf": [{"format": "date-time", "type": "string"}, {"type": "null"}], "default": null, "description": "An audit timestamp to write back the completion of the session - its optional as it should manage the last timestamp on the AI Responses for the session", "title": "Session Completed At"}, "graph_paths": {"anyOf": [{"items": {"type": "string"}, "type": "array"}, {"type": "null"}], "default": null, "description": "Track all paths extracted by an agent as used to build the KG over user sessions", "title": "Graph Paths"}}, "required": ["id"], "title": "Session", "type": "object"}', NULL)
    ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, category = EXCLUDED.category, description = EXCLUDED.description, spec = EXCLUDED.spec, functions = EXCLUDED.functions;
-- ------------------
