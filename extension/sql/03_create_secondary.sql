...
INSERT INTO p8."Function"(name,id,key,verb,endpoint,description,function_spec,proxy_uri) VALUES
 ...
 ('help', '19ecd3b1-f79a-3ae9-8388-4c5ec8a7072b', 'native.help', 'get', 'help', 'Help us a planning utility. When you ask a question because you need help or tools to call\nthis function will search and return a list of resources or information for you', '{"name": "help", "parameters": {"properties": {"questions": {"description": "ask one or more questions to receive information and a plan of action", "items": {"type": "string"}, "type": "array"}}, "required": ["questions"], "type": "object"}, "description": "Help us a planning utility. When you ask a question because you need help or tools to call\\nthis function will search and return a list of resources or information for you"}', 'native'),
 ('announce_generate_large_output', 'c7c88a1e-eb0e-31f5-9dc2-33c83efe22c1', 'native.announce_generate_large_output', 'get', 'announce_generate_large_output', 'When you are about to generate a lot of output for example something that is greater than several thousand tokens and/or will take more than 4 seconds to generate, please call this function with a rough estimate of the size of the content.\nYou do not need to do this when you are responding with simple structured responses which are typically small or with simple answers.\nHowever when generating lots of text we would like to request via streaming or async so we want to know before generating a lot of text.\nWe use to distinguish internal content gathering nodes from final response generation for users.', '{"name": "announce_generate_large_output", "parameters": {"properties": {"estimated_length": {"type": "integer"}}, "type": "object"}, "description": "When you are about to generate a lot of output, please call this function with a rough estimate of the size of the content.\\nYou do not need to do this when you are responding with simple structured responses which are typically small or with simple answers.\\nHowever when generating lots of text we would like to request via streaming or async so we want to know before generating a lot of text.\\nWe use to distinguish internal content gathering nodes from final response generation for users."}', 'native')
