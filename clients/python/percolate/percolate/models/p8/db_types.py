...
class Ask(BaseModel):
    ...
    tool_calls: typing.Optional[typing.List[dict]] = Field(description="The tool call payload from the language model possible in a canonical format e.g. OpenAI scheme")
    tool_call_result: typing.List[dict] = Field(description="JSON data result from tool calls")
