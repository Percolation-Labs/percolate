...
expected_out_examples_no_tools = {'claude-3-5-sonnet-20241022': {'id': 'msg_011WH7cvyM9LGa87nsu3dQ6P',
  ...
  'content': [{'type': 'text',
    'text': "The capital of Ireland is Dublin.\n\nFun fact: The St. James's Gate Brewery in Dublin, where Guinness was first brewed in 1759, signed a 9,000-year lease for its property. The lease was signed by Arthur Guinness for an annual rent of £45. The brewery is still operating today and is one of Ireland's most popular tourist attractions!"}],
