#!/usr/bin/env python3
"""Simple test of the user upload search endpoint."""
...
def test_endpoint():
    """Test the endpoint with minimal request."""
    print("Testing GET /tus/user/uploads...")
    ...
    print("\n\nTesting POST /tus/user/uploads/search...")
    
    try:
        # Minimal POST request
        response = session.post(f'{base_url}/tus/user/uploads/search', json={"limit": 5})
        print(f"Status Code: {response.status_code}")
